...
Original Video Data for .mp4 is 16G, flushed_data_new for .npz is 120m, which both are impossible to upload. Run VideoCapture2.py could download those file, but it took 20 hours in total for me. I used
MSL_TRAIN25, MSL_TEST25, MSL_VAL25 and MSL_test and mixed them together as my general dataset.

VideoProcess.py do hand detect from .mp4 into .npz, which significantly makes the training into possible. Transforming all .mp4 into .npz took me 8 hours.
